    ...
    <div className="min-h-screen bg-gray-950 p-4 md:p-8 font-sans">
      ...
      <header className="mb-8 flex justify-between items-center max-w-7xl mx-auto">
        ...
        <button
          ...
          className="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:bg-gray-200 transition-colors shadow-sm"
        >
          Add Photo
        </button>
      </header>
        ...
        <div className="max-w-7xl mx-auto columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
          {photos.map((photo) => {
            ...
            return (
              <div
                key={photo.id}
                className="break-inside-avoid cursor-zoom-in group relative overflow-hidden bg-gray-900 shadow-sm hover:shadow-xl transition-all"
